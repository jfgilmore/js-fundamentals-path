...
const aIntegerNumber = 3;
const anotherIntegerNumber = 10;
add(aIntegerNumber, anotherIntegerNumber);
const aFloatNumber = 0.3142908;
const anotherFloatNumber = 3.14930824;
add(aFloatNumber, anotherFloatNumber);
...
const objTwo = { bread : "toast" };

function objectTwoPrinter(object) {
    console.log(object.bread);
}

objectTwoPrinter(objTwo);
